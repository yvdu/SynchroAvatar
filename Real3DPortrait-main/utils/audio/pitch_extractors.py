...
from utils2.audio import librosa_wav2spec
from utils2.audio.io import save_wav

os.environ["TF_CPP_MIN_LOG_LEVEL"] = "2"
import librosa
import numpy as np
from scipy.interpolate import interp1d
from utils2.audio.pitch.crepe_utils import crepe_with_corrector, crepe_predict, frequency_to_bins, \
    crepe_predict_torch
from utils2.audio.pitch.extractor_utils import find_nearest_stft_bin, find_best_f0_using_har_energy
...
def reaper_extract_f0(wav_data, hop_size, audio_sample_rate, f0_min, f0_max, denoise=True,
    ...
    with tempfile.TemporaryDirectory(dir=dirname) as _:
        ...
        if denoise:
            from utils2.audio import trim_long_silences
            wav_data_ = wav_data
